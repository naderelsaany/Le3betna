...
class _LoginScreenState extends State<LoginScreen> with SingleTickerProviderStateMixin {
  ...
  Future<void> _signInWithGoogle() async {
    HapticFeedback.heavyImpact(); // Gaming feel when clicked!
    setState(() {
      _isLoading = true;
      _errorMessage = null;
    });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Directionality(
        textDirection: TextDirection.rtl, // Strict RTL support
        child: Stack(
          children: [
            // Subtle Background Glow
            Positioned(
              top: -150,
              right: -100, // Adjusted for RTL
              child: Container(
                width: 400,
                height: 400,
            ...
            Positioned(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(color: AppColors.secondary.withOpacity(0.1), blurRadius: 120, spreadRadius: 60),
                  ],
                ),
              ),
            ),
                  ...
                  child: FadeTransition(
                    ...
                    child: SlideTransition(
                      ...
                      child: ConstrainedBox(
                        ...
                        child: Container(
                          decoration: BoxDecoration(
                            color: AppColors.surface, // Solid clean surface
                                        ...
                                        child: ClipOval(
                                          child: Image.network(
                                            ...
                                            errorBuilder: (context, error, stackTrace) => const Icon(
                                              Icons.extension_rounded, // Material Rounded Icon
                                              size: 40,
...
class _GoogleLoginButtonState extends State<_GoogleLoginButton> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _scaleController = AnimationController(
      vsync: this,
      duration: const Duration(milliseconds: 300), // Spring needs slightly longer duration
      lowerBound: 0.95,
      upperBound: 1.0,
      value: 1.0,
    );
  ...
  Widget build(BuildContext context) {
    return MouseRegion(
      onEnter: (_) {
        HapticFeedback.lightImpact(); // Subtle hover feedback
      ...
      child: GestureDetector(
        onTapDown: (_) {
          if (!widget.isLoading) {
            _scaleController.reverse(); // Shrink slightly
          ...
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: _isHovered && !widget.isLoading
                  ? [BoxShadow(color: AppColors.primary.withOpacity(0.25), blurRadius: 20, offset: const Offset(0, 4))]
                  : [],
            ),
